...
- ✅ done — `#log` scrollable while the agent is "thinking…"; chat history rebuilt as a `ChatLog` widget that only auto-scrolls when already at the bottom (see [[changelog#2026-07-21|changelog]])
