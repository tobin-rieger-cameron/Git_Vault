...
class Surface():
    ...
    """
    def __init__(self, x, y, length, width, area, position, perimeter: list[Line]):
        self.x = x
        self.y = y
        self.length = length
        self.width = width
        self.area = length * width
        self.position = Point(x, y)# center point
...
class PlaneSurface(Surface): 
    #TODO: """ a flat surface lies evenly with all the points in itself """
    pass
...
class Angle:
    ...
    def draw(self, color=rl.RED, thickness=2):
        #TODO:"""draw a curved line to represent the angle"""
        pass
