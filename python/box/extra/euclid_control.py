...
points = [Point(100, 100), Point(400, 300), Point(200, 450), Point(600, 200)]
...
while running:
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if event.button == 1:  # Left mouse button
                for point in points:
                    if point.is_hovered(mouse_x, mouse_y):
                ...
                for point in points:
                    if point.is_hovered(mouse_x, mouse_y):
                        ...
                        # If we have a start point and clicked a different point
                            ...
                            for line in lines:
                                if (
                                    line.point1 == line_start_point
                                    and line.point2 == point
                                ) or (
                                    line.point2 == line_start_point
                                    and line.point1 == point
                                ):
                                    line_exists = True
                                    line_to_remove = line
                                    break
    ...
    if drawing_line and line_start_point:
        pygame.draw.line(
            screen,
            GREEN,
            (line_start_point.x, line_start_point.y),
            (mouse_x, mouse_y),
            1,
        )
    ...
    instructions = [
        "Space: Create new point or hold existing point",
